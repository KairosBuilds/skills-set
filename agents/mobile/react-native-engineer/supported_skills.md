# Supported Skills — React Native Engineer

## Primary Skills
| Skill | Description | Priority |
|-------|-------------|----------|
| mobile/react-native-expert | React Native development, optimization, and debugging | core |

## Secondary Skills
| Skill | Description | Priority |
|-------|-------------|----------|
| frontend/react-expert | React component design and hooks | high |
