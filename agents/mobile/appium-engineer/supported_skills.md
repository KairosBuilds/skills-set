# Supported Skills — Appium Engineer

## Primary Skills
| Skill | Description | Priority |
|-------|-------------|----------|
| mobile/appium-python-expert | Appium 2.x testing with Python and pytest | core |
...
| Skill | Description | Priority |
|-------|-------------|----------|
| security/secure-code-guardian | Security testing automation | low |
| code-quality/code-reviewer | Test code review | low |
| devops/terraform-engineer | Infrastructure for device labs | low |
