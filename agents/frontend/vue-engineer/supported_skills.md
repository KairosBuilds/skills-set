...
1. `frontend/vue-expert` — always active
2. `frontend/typescript-pro` — active for typed components
3. `testing/testing-unit` — active during test phase
